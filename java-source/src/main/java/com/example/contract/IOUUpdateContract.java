 ...
 */
public class IOUUpdateContract implements Contract {
    public static final String IOU_UPDATE_CONTRACT_ID = "com.example.contract.IOUUpdateContract";
    ...
    public void verify(LedgerTransaction tx) {
        final CommandWithParties<Commands.Update> command = requireSingleCommand(tx.getCommands(), Commands.Update.class);
        requireThat(require -> {
